-- FIX: INFINITE RECURSION IN PROFILES RLS (V3 - CASCADE + ALL TABLES)
-- This script repairs the get_auth_family_id function and applies a non-recursive policy for all tables.

-- 1. DROP OLD FUNCTIONS WITH CASCADE
-- CASCADE will automatically drop dependent policies on profiles, families, etc.
